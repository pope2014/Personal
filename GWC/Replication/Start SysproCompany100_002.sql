...
:SETVAR Pub   "SysproCompany100_002"
:SETVAR PubS "'SysproCompany100_002'"
-------------------------------------------------------------------------------
-- Add a subscription for the publication at the publisher.
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SysproCompany100.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC SysproCompany100.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC SysproCompany100.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'SysproCompany100', 
...
GO
EXEC SysproCompany100.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
