...
:SETVAR Pub   "SalesOrderAllocation100_001"
:SETVAR PubS "'SalesOrderAllocation100_001'"
-------------------------------------------------------------------------------
-- Add a subscription for the publication at the publisher.
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SalesOrderAllocation100.sys.sp_addsubscription 
  @publication                      = $(Pub),
...
EXEC SalesOrderAllocation100.sys.sp_addpullsubscription 
  @publication                      = $(Pub), 
...
-------------------------------------------------------------------------------
:CONNECT SQLREPORTING
EXEC SalesOrderAllocation100.sys.sp_addpullsubscription_agent 
  @publication                      = $(Pub), 
  @publisher                        = N'SQL2008NEW', 
  @publisher_db                     = N'SalesOrderAllocation100', 
...
GO
EXEC SalesOrderAllocation100.sys.sp_startpublication_snapshot 
  @publication                      = $(Pub);
GO
