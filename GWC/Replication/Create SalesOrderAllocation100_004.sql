...
--  @dbname = N'SalesOrderAllocation100',
--  @optname = N'publish',
--  @value = N'true';
--GO
...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SalesOrderAllocation100.sys.sp_addpublication
  @publication                      = $(Pub),
  @description                      = N'SQL08',
...
-------------------------------------------------------------------------------
:CONNECT SQL2008NEW
EXEC SalesOrderAllocation100.sys.sp_addpublication_snapshot 
  @publication                      = $(Pub),
  @frequency_type                   = 1,
...
EXEC DBAdmin.Repl.AddArticle_SalesOrderAllocation100 @Pub, @Num OUTPUT;
SELECT @Num AS Num;
